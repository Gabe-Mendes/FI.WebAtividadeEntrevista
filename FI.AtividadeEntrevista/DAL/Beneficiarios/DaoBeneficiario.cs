...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        /// <summary>
        /// Valida se CPF já é beneficiario
        /// </summary>
        /// <param name="beneficiario">Objeto de cliente</param>
        ...
        internal List<DML.Beneficiario> Listar(long idCliente)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_ListaBeneficiarios", parametros);
        ...
        internal void Excluir(long id)
        {
            ...
            base.Executar("FI_SP_ExcluiBeneficiario", parametros);
        }

        /// <summary>
        /// Busca Beneficiario
        /// </summary>
        internal DML.Beneficiario Consultar(long idBeneficiario)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
